...
public class CustomSystemSettingsTest {
    ...
    public void test() {
        ...
        CustomSystemSettings systemSettings = CustomSystemSettings.fromString(settings);
        ...
        assertEquals(8, systemSettings.boardEvaluators.get("Tengstrand1").boardWidth());
        assertEquals(18, systemSettings.boardEvaluators.get("Tengstrand1").boardHeight());
    }
}
