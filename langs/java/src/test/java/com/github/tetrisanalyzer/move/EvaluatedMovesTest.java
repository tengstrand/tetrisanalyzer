...
public class EvaluatedMovesTest {
    ...
    private EvaluatedMoves getEvaluatedMoves() {
        ...
        PieceMove startPieceMove = new ValidPieceMovesForEmptyBoard(board, piece, settings).calculateStartMove(board);
    ...
    public void evaluatedMoves() {
        ...
        expectedMoves.add(new MoveEquity(new PieceMove(piece, new Move(0,0, 18)), 2.504));
        ...
        expectedMoves.add(new MoveEquity(new PieceMove(piece, new Move(1,8, 17)), 3.777));
        expectedMoves.add(new MoveEquity(new PieceMove(piece, new Move(0,3, 18)), 3.855));
        expectedMoves.add(new MoveEquity(new PieceMove(piece, new Move(0,1, 18)), 4.115));
        expectedMoves.add(new MoveEquity(new PieceMove(piece, new Move(0,4, 18)), 4.389));
        expectedMoves.add(new MoveEquity(new PieceMove(piece, new Move(0,6, 18)), 5.323));
        ...
        expectedMoves.add(new MoveEquity(new PieceMove(piece, new Move(1,7, 17)), 8.319));
        expectedMoves.add(new MoveEquity(new PieceMove(piece, new Move(1,3, 17)), 9.075));
        expectedMoves.add(new MoveEquity(new PieceMove(piece, new Move(1,1, 17)), 10.824));
