...
public class GameTest {
    ...
    public void playFivePieces() {
        ...
        GameState result = new GameState(Duration.create(), board, board.copy(), distribution, boardEvaluator, pieceGenerator, 0, 0, 0, 1, 1, null, 0, 0, 0, 0, 0, 0, 0, 5);
    ...
    public void slidePiece() {
        ...
        Distribution distribution = new Distribution(board.width, board.height);
        GameState result = new GameState(Duration.create(), board, board.copy(), distribution, boardEvaluator, pieceGenerator, 0, 0, 0, 1, 1, null, 0, 0, 0, 0, 0, 0, 0, 1);
        Game game = new Game(result, settings, false, false);
        game.run();
