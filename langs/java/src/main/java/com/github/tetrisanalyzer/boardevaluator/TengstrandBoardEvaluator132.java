                ...
                if (areaWidth == 0 && previousAreaWidth == 0) {
                    ...
                    if (areaWidth > 0 && (areaWidth == previousAreaWidth || previousAreaWidth == 0)) {
                        ...
                        if (hasAreaWallsSameHeight) {
                            equity += areaWidthFactors[previousAreaWidth] * areaHeightEqFactors[areaHeight] * heightHollowOutlineFactors[y - areaHeight/2];
                        } else {
                            equity += areaWidthFactors[previousAreaWidth] * areaHeightFactors[areaHeight] * heightHollowOutlineFactors[y - areaHeight/2];
                        }
                        areaHeight = 1;
