...
/**
 * Joakim Tengstrand's Tetris AI, version 1.4 (an experiment, work in progress!)
 */
public class TengstrandBoardEvaluator141 implements BoardEvaluator {
    ...
    public TengstrandBoardEvaluator141(int boardWidth, int boardHeight, GameSettings rules) {
        init(boardWidth, boardHeight);
    }

    public TengstrandBoardEvaluator141(int boardWidth, int boardHeight, GameSettings rules, Map settings) {
