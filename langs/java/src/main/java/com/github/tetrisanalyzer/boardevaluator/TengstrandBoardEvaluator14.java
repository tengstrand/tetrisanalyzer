 ...
 */
public class TengstrandBoardEvaluator14 implements BoardEvaluator {
    ...
    public TengstrandBoardEvaluator14(int boardWidth, int boardHeight, GameSettings rules) {
        init(boardWidth, boardHeight);
    }

    public TengstrandBoardEvaluator14(int boardWidth, int boardHeight, GameSettings rules, Map settings) {
