...
class JTengstrandBoardEvaluator1DefaultSettingsTest extends BaseTest {
  ...
  @Test def evaluateVersionOneDotOne(): Unit = {
  ...
  @Test def calculateBlocksPerRowHollowFactor_width15(): Unit = {
  ...
  @Test def calculateBlocksPerRowHollowFactor_width8(): Unit = {
